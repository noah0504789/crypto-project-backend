...
- 모듈별 상세는 `docs/modules/*.md`(현재 user·chat·market·market-detection·notification·common·oauth2-authorization-server·oauth2-client·api-gateway·config·eureka 커버). 특정 모듈 디렉토리에서 작업하면 그 디렉토리의 `CLAUDE.md`(모듈 작업 규칙)가 자동 로드된다.
