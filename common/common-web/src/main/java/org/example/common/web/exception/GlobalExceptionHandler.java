...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ValidationResult> handleConstraintViolationException(ConstraintViolationException e) {
        log.warn("[rest] Constraint violation occurred");
    ...
    public ResponseEntity<ValidationResult> handleMethodArgumentNotValidException(Exception e) {
        log.warn("[rest] Validation error occurred");
    ...
    public ResponseEntity<Void> handleResourceNotFoundException(ResourceNotFoundException e) {
        log.warn("[rest] Resource not found: {}", e.getMessage());
        return ResponseEntity.noContent().build();
    }

    @ExceptionHandler(ForbiddenException.class)
    public ResponseEntity<ErrorResponse> handleForbiddenException(ForbiddenException e) {
        log.warn("[rest] Forbidden: {}", e.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidRequestException(InvalidRequestException e) {
        log.warn("[rest] Invalid resource request: {}", e.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        log.warn("[rest] Http message not readable: {}", e.getMessage());
        return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ErrorResponse> handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        log.warn("[rest] Missing request parameter: {}", e.getMessage());
        return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ErrorResponse> handleMissingRequestHeaderException(MissingRequestHeaderException e) {
        log.warn("[rest] Missing request header: {}", e.getMessage());
        return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
        log.warn("[rest] Method argument type mismatch: {}", e.getMessage());
        return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ErrorResponse> handleInfrastructureException(InfrastructureException e) {
        log.error("[rest] Infrastructure error: {}", e.getMessage(), e);
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception e) {
        log.error("[rest] Unexpected error occurred: {}", e.getMessage(), e);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
