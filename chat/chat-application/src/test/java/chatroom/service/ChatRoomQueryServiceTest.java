...
class ChatRoomQueryServiceTest {
    ...
    @Test
    @DisplayName("listMostPopular: 캐시 히트 시 인기 채팅방 목록을 캐시에서 반환한다")
    ...
    @Test
    @DisplayName("listMostPopular: 캐시 미스 시 repairMostPopular로 인기 채팅방 목록을 복구 조회한다")
    ...
    @Test
    @DisplayName("listNextPopular: 캐시 히트 시 다음 인기 채팅방 목록을 캐시에서 반환한다")
    ...
    @Test
    @DisplayName("listNextPopular: 캐시 미스 시 repairNextPopular로 다음 인기 채팅방 목록을 복구 조회한다")
    ...
    @Test
    @DisplayName("listLatestActive: active 캐시 히트 시 lastRead 캐시를 사용해 내 채팅방 Summary 목록을 반환한다")
    ...
    @Test
    @DisplayName("listLatestActive: active 캐시 미스 시 복구 조회 후 영속 저장소의 lastRead 기준으로 active 캐시를 갱신한다")
    ...
    @Test
    @DisplayName("listActiveBefore: active 캐시 미스 시 repairActiveBefore로 복구 조회하고 lastRead 기준으로 active 캐시를 갱신한다")
