...
for i = 1, roomCount do
    ...
    local roomId = ARGV[argIndex]; argIndex = argIndex + 1
    local title = ARGV[argIndex]; argIndex = argIndex + 1
    local popularity = tonumber(ARGV[argIndex]); argIndex = argIndex + 1
    ...
    local infoPairCount = tonumber(ARGV[argIndex]); argIndex = argIndex + 1
