...
local scoreIncrement = tonumber(ARGV[5])
local content = ARGV[6]
local writerId = ARGV[7]
local messageJson = ARGV[8]
...
redis.call("ZINCRBY", roomPopularKey, scoreIncrement, roomId)
