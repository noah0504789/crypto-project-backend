...
public class RedisChatRoomCodec implements RedisHashCodec<RedisChatRoom> {
    ...
    public RedisChatRoom read(Map<String, String> source) {
        ...
        return RedisChatRoom.builder()
                ...
                .latestMessageSeq(RedisCodecSupport.parseLongOrDefault(
                        source.get("latest_message_seq"),
    ...
    public Map<String, String> write(RedisChatRoom room) {
        ...
        map.put("latest_message_seq", room.getLatestMessageSeq() == null ? "0" : room.getLatestMessageSeq() + "");
    ...
    public Map<String, String> writePartial(Map<String, Object> updated) {
        ...
        updated.forEach((k, v) -> {
            switch (k) {
                ...
                case "latestMessageSeq", "latest_message_seq" ->
                        map.put("latest_message_seq", RedisCodecSupport.str(v));
