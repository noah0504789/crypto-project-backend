...
public class MongoConfig {
    ...
    @Bean("notificationMongoTransactionManager")
    public MongoTransactionManager notificationMongoTransactionManager(MongoDatabaseFactory notificationMongoDbFactory) {
        TransactionOptions transactionOptions = TransactionOptions.builder()
                .readPreference(ReadPreference.primary())
                .build();

        return new MongoTransactionManager(notificationMongoDbFactory, transactionOptions);
    }
}
