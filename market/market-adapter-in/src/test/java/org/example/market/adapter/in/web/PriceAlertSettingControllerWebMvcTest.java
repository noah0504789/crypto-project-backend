...
class PriceAlertSettingControllerWebMvcTest {
    ...
    @Test
    @DisplayName("changeMySettings(): create code가 공백이면 ValidationResult 형식으로 응답한다")
    void changeMySettings_shouldReturnValidationResult_whenCreateCodeIsBlank() throws Exception {
        ...
        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(new PriceAlertSettingChangeRequest.CreatePriceAlertSettingRequest("", true, new BigDecimal("0.03"))),
                List.of(),
                List.of()
        );
    ...
    @Test
    @DisplayName("changeMySettings(): update targetChangeRate가 null이면 ValidationResult 형식으로 응답한다")
    void changeMySettings_shouldReturnValidationResult_whenUpdateTargetChangeRateIsNull() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(),
                List.of(new PriceAlertSettingChangeRequest.UpdatePriceAlertSettingRequest("KRW-BTC", true, null)),
                List.of()
        );
    ...
    @Test
    @DisplayName("changeMySettings(): update targetChangeRate가 0.01보다 작으면 ValidationResult 형식으로 응답한다")
    void changeMySettings_shouldReturnValidationResult_whenUpdateTargetChangeRateIsTooSmall() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(),
                List.of(new PriceAlertSettingChangeRequest.UpdatePriceAlertSettingRequest("KRW-BTC", true, new BigDecimal("0.001"))),
                List.of()
        );
    ...
    @Test
    @DisplayName("changeMySettings(): update targetChangeRate가 1.00보다 크면 ValidationResult 형식으로 응답한다")
    void changeMySettings_shouldReturnValidationResult_whenUpdateTargetChangeRateIsTooLarge() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(),
                List.of(new PriceAlertSettingChangeRequest.UpdatePriceAlertSettingRequest("KRW-BTC", true, new BigDecimal("1.01"))),
                List.of()
        );
    ...
    @Test
    @DisplayName("changeMySettings(): delete code가 공백이면 ValidationResult 형식으로 응답한다")
    void changeMySettings_shouldReturnValidationResult_whenDeleteCodeIsBlank() throws Exception {
        ...
        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(),
                List.of(),
                List.of(new PriceAlertSettingChangeRequest.DeletePriceAlertSettingRequest(""))
        );
    ...
    @Test
    @DisplayName("changeMySettings(): creates, updates, deletes에 validation 오류가 함께 있으면 errors 배열로 응답한다")
    void changeMySettings_shouldReturnValidationResult_whenMultipleNestedRequestsAreInvalid() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(new PriceAlertSettingChangeRequest.CreatePriceAlertSettingRequest("", true, new BigDecimal("0.03"))),
                List.of(new PriceAlertSettingChangeRequest.UpdatePriceAlertSettingRequest("KRW-ETH", true, new BigDecimal("1.01"))),
                List.of(new PriceAlertSettingChangeRequest.DeletePriceAlertSettingRequest(""))
        );
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.errors[*].field").value(
                        containsInAnyOrder("code", "targetChangeRate", "code")
                ))
                ...
                .andExpect(jsonPath("$.errors[*].code").value(
                        containsInAnyOrder("NotBlank", "DecimalMax", "NotBlank")
                ))
    ...
    @Test
    @DisplayName("changeMySettings(): updates만 있으면 creates와 deletes가 비어 있어도 정상 처리한다")
    void changeMySettings_shouldWork_whenOnlyUpdatesExist() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(),
                List.of(new PriceAlertSettingChangeRequest.UpdatePriceAlertSettingRequest("KRW-BTC", true, new BigDecimal("0.03"))),
                List.of()
        );
                ...
                .changeMySettings(
                        ...
                        argThat(command ->
                                command.creates().isEmpty()
                                        ...
                                        && command.updates().get(0).targetChangeRate().compareTo(new BigDecimal("0.03")) == 0
                        )
                );
    }

    @Test
    @DisplayName("changeMySettings(): creates, updates, deletes가 함께 있으면 정상 처리한다")
    void changeMySettings_shouldWork_whenCreatesUpdatesDeletesExistTogether() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(
                List.of(new PriceAlertSettingChangeRequest.CreatePriceAlertSettingRequest("KRW-BTC", true, new BigDecimal("0.03"))),
                List.of(new PriceAlertSettingChangeRequest.UpdatePriceAlertSettingRequest("KRW-ETH", false, new BigDecimal("0.05"))),
                List.of(new PriceAlertSettingChangeRequest.DeletePriceAlertSettingRequest("KRW-XRP"))
        );
                ...
                .changeMySettings(
                        ...
                        argThat(command ->
                                command.creates().size() == 1
                                        ...
                                        && command.creates().get(0).targetChangeRate().compareTo(new BigDecimal("0.03")) == 0
                                        && command.updates().get(0).code().equals("KRW-ETH")
                                        && !command.updates().get(0).enabled()
                                        && command.updates().get(0).targetChangeRate().compareTo(new BigDecimal("0.05")) == 0
    ...
    @Test
    @DisplayName("changeMySettings(): updates 키만 있어도 정상 처리한다")
    ...
    @Test
    @DisplayName("changeMySettings(): creates, updates, deletes 키가 모두 없어도 빈 command로 정상 처리한다")
    ...
    @Test
    @DisplayName("changeMySettings(): creates, updates, deletes가 모두 null이어도 빈 command로 정상 처리한다")
    void changeMySettings_shouldWork_whenListsAreNull() throws Exception {
        UUID userPublicId = UUID.randomUUID();

        PriceAlertSettingChangeRequest request = new PriceAlertSettingChangeRequest(null, null, null);
